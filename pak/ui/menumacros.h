// ===================================================================
// menumacros.h - Modern UI Theme (Clean & Minimal)
// ===================================================================
//
// Color Palette Reference:
//   Background:    0.08 0.08 0.10  @ 0.85 alpha
//   Surface:       0.12 0.12 0.14  @ 0.80 alpha
//   Text primary:  0.92 0.92 0.95
//   Text muted:    0.55 0.55 0.60
//   Accent:        0.45 0.65 0.95  (cool blue)
//   Accent hover:  0.55 0.75 1.00
//   Button bg:     0.15 0.15 0.18  @ 0.60 alpha
//   Button hover:  0.20 0.22 0.28  @ 0.75 alpha
//   Border:        0.25 0.25 0.28  @ 0.35 alpha
//   Danger:        0.85 0.30 0.30
//   Success:       0.30 0.75 0.45
//   Warning:       0.95 0.75 0.25
// ===================================================================


// -------------------------------------------------------------------
// WINDOW - Full-screen or in-game panel container
// -------------------------------------------------------------------
...
#define WINDOW_FUI( WINDOW_TEXT, GRADIENT_START_OFFSET )														\
	...
	itemDef {																								\
		...
		backcolor	0.08 0.08 0.10 .78																		\
		border		WINDOW_BORDER_FULL																		\
		bordercolor	0.25 0.25 0.28 .30																		\
		visible		1																						\
		decoration																							\
	}																										\
																											\
	...
	itemDef {																								\
		name		"titlebar"																				\
		group		GROUP_NAME																				\
		rect		1 1 $evalint(WINDOW_WIDTH-2) THEME_TITLE_HEIGHT											\
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.10 0.12 0.16 .92																		\
		visible		1																						\
		decoration																							\
	}																										\
																											\
	/* Title accent line (bottom of title bar) */															\
	itemDef {																								\
		name		"titleaccent"																			\
		group		GROUP_NAME																				\
		rect		1 $evalint(THEME_TITLE_HEIGHT+1) $evalint(WINDOW_WIDTH-2) THEME_TITLE_ACCENT_H			\
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.45 0.65 0.95 .50																		\
		visible		1																						\
		decoration																							\
	}																										\
																											\
	...
	itemDef {																								\
		name		"windowtitle"																			\
		group		GROUP_NAME																				\
		rect		2 1 $evalint(WINDOW_WIDTH-4) THEME_TITLE_HEIGHT											\
		text		WINDOW_TEXT																				\
		textfont	THEME_FONT_TITLE																		\
		textscale	THEME_TITLE_TEXT_SCALE																	\
		textalignx	THEME_SPACING_LG																		\
		textaligny	20																						\
		forecolor	0.75 0.80 0.90 1																		\
		visible		1																						\
		decoration																							\
	}
...
#define WINDOW_INGAME( WINDOW_TEXT, GRADIENT_START_OFFSET )													\
	...
	itemDef {																								\
		...
		rect		0 0 WINDOW_WIDTH WINDOW_HEIGHT															\
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.08 0.08 0.10 .85																		\
		border		WINDOW_BORDER_FULL																		\
		bordercolor	0.25 0.25 0.28 .35																		\
		visible		1																						\
		decoration																							\
	}																										\
																											\
...
// -------------------------------------------------------------------
// SUBWINDOW - Section within a panel
// -------------------------------------------------------------------
...
#define SUBWINDOW( SUBWINDOW_X, SUBWINDOW_Y, SUBWINDOW_W, SUBWINDOW_H, SUBWINDOW_TEXT )					\
	itemDef {																								\
		...
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.06 0.06 0.08 .40																		\
		border		WINDOW_BORDER_FULL																		\
		bordercolor	0.22 0.22 0.25 .30																		\
		visible		1																						\
		decoration																							\
	}																										\
																											\
	itemDef {																								\
		...
		group		GROUP_NAME																				\
		rect		$evalfloat((SUBWINDOW_X)+1) $evalfloat((SUBWINDOW_Y)+1) $evalfloat((SUBWINDOW_W)-2) THEME_SUBTITLE_HEIGHT	\
		text		SUBWINDOW_TEXT																			\
		textfont	UI_FONT_ARIBLK_16																		\
		textscale	THEME_SUBTITLE_SCALE																	\
		textalignx	THEME_SPACING_SM																		\
		textaligny	11																						\
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.12 0.14 0.18 .70																		\
		forecolor	0.55 0.60 0.70 1																		\
		visible		1																						\
		decoration																							\
	}
...
#define SUBWINDOWBLACK( SUBWINDOWBLACK_X, SUBWINDOWBLACK_Y, SUBWINDOWBLACK_W, SUBWINDOWBLACK_H, SUBWINDOWBLACK_TEXT )	\
	...
	itemDef {																								\
		...
		group		GROUP_NAME																				\
		rect		$evalfloat((SUBWINDOWBLACK_X)+1) $evalfloat((SUBWINDOWBLACK_Y)+1) $evalfloat((SUBWINDOWBLACK_W)-2) THEME_SUBTITLE_HEIGHT	\
...
#define BUTTON( BUTTON_X, BUTTON_Y, BUTTON_W, BUTTON_H, BUTTON_TEXT, BUTTON_TEXT_SCALE, BUTTON_TEXT_ALIGN_Y, BUTTON_ACTION )	\
	itemDef {																								\
		...
		text		BUTTON_TEXT																				\
		textfont	THEME_FONT_BTN																			\
		textscale	BUTTON_TEXT_SCALE																		\
		textalign	ITEM_ALIGN_CENTER																		\
		textalignx	$evalfloat(0.5*(BUTTON_W))																\
		textaligny	BUTTON_TEXT_ALIGN_Y																		\
		style		WINDOW_STYLE_FILLED																		\
		backcolor	0.15 0.15 0.18 .55																		\
		forecolor	0.78 0.80 0.84 1																		\
		border		WINDOW_BORDER_FULL																		\
		bordercolor	0.25 0.25 0.28 .25																		\
		visible		1																						\
																											\
		mouseEnter {																						\
			setitemcolor "bttn"##BUTTON_TEXT forecolor 1 1 1 1 ;											\
			setitemcolor "bttn"##BUTTON_TEXT backcolor .20 .22 .28 .75 ;									\
			setitemcolor "bttn"##BUTTON_TEXT bordercolor .35 .45 .65 .50									\
		}																									\
																											\
		mouseExit {																							\
			setitemcolor "bttn"##BUTTON_TEXT forecolor .78 .80 .84 1 ;										\
			setitemcolor "bttn"##BUTTON_TEXT backcolor .15 .15 .18 .55 ;									\
			setitemcolor "bttn"##BUTTON_TEXT bordercolor .25 .25 .28 .25									\
		}																									\
																											\
		action {																							\
			setitemcolor "bttn"##BUTTON_TEXT forecolor .78 .80 .84 1 ;										\
...
// -------------------------------------------------------------------
// BUTTONEXT - Button with extra properties block
// -------------------------------------------------------------------
...
#define BUTTONEXT( BUTTONEXT_X, BUTTONEXT_Y, BUTTONEXT_W, BUTTONEXT_H, BUTTONEXT_TEXT, BUTTONEXT_TEXT_SCALE, BUTTONEXT_TEXT_ALIGN_Y, BUTTONEXT_ACTION, BUTTONEXT_EXT )	\
	itemDef {																								\
		...
		mouseEnter {																						\
			...
			setitemcolor "bttnext"##BUTTONEXT_TEXT backcolor .20 .22 .28 .75 ;								\
			setitemcolor "bttnext"##BUTTONEXT_TEXT bordercolor .35 .45 .65 .50								\
		}																									\
																											\
		mouseExit {																							\
			setitemcolor "bttnext"##BUTTONEXT_TEXT forecolor .78 .80 .84 1 ;								\
			setitemcolor "bttnext"##BUTTONEXT_TEXT backcolor .15 .15 .18 .55 ;								\
			setitemcolor "bttnext"##BUTTONEXT_TEXT bordercolor .25 .25 .28 .25								\
		}																									\
																											\
		action {																							\
			setitemcolor "bttnext"##BUTTONEXT_TEXT forecolor .78 .80 .84 1 ;								\
...
// -------------------------------------------------------------------
// NAMEDBUTTON - Button with explicit name
// -------------------------------------------------------------------
...
#define NAMEDBUTTON( NAMEDBUTTON_NAME, NAMEDBUTTON_X, NAMEDBUTTON_Y, NAMEDBUTTON_W, NAMEDBUTTON_H, NAMEDBUTTON_TEXT, NAMEDBUTTON_TEXT_SCALE, NAMEDBUTTON_TEXT_ALIGN_Y, NAMEDBUTTON_ACTION )	\
	itemDef {																								\
		...
		mouseEnter {																						\
			...
			setitemcolor NAMEDBUTTON_NAME backcolor .20 .22 .28 .75 ;										\
			setitemcolor NAMEDBUTTON_NAME bordercolor .35 .45 .65 .50										\
		}																									\
																											\
		mouseExit {																							\
			setitemcolor NAMEDBUTTON_NAME forecolor .78 .80 .84 1 ;											\
			setitemcolor NAMEDBUTTON_NAME backcolor .15 .15 .18 .55 ;										\
			setitemcolor NAMEDBUTTON_NAME bordercolor .25 .25 .28 .25										\
		}																									\
																											\
		action {																							\
			setitemcolor NAMEDBUTTON_NAME forecolor .78 .80 .84 1 ;											\
...
// -------------------------------------------------------------------
// NAMEDBUTTONEXT - Named button with extra properties
// -------------------------------------------------------------------
...
#define NAMEDBUTTONEXT( NAMEDBUTTONEXT_NAME, NAMEDBUTTONEXT_X, NAMEDBUTTONEXT_Y, NAMEDBUTTONEXT_W, NAMEDBUTTONEXT_H, NAMEDBUTTONEXT_TEXT, NAMEDBUTTONEXT_TEXT_SCALE, NAMEDBUTTONEXT_TEXT_ALIGN_Y, NAMEDBUTTONEXT_ACTION, NAMEDBUTTONEXT_EXT )	\
	itemDef {																								\
		...
		mouseEnter {																						\
			...
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .20 .22 .28 .75 ;									\
			setitemcolor NAMEDBUTTONEXT_NAME bordercolor .35 .45 .65 .50									\
		}																									\
																											\
		mouseExit {																							\
			setitemcolor NAMEDBUTTONEXT_NAME forecolor .78 .80 .84 1 ;										\
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .15 .15 .18 .55 ;									\
			setitemcolor NAMEDBUTTONEXT_NAME bordercolor .25 .25 .28 .25									\
		}																									\
																											\
		action {																							\
			setitemcolor NAMEDBUTTONEXT_NAME forecolor .78 .80 .84 1 ;										\
...
// -------------------------------------------------------------------
// NUMERICFIELD - Numeric input field
// -------------------------------------------------------------------
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "yn"##YESNO_TEXT forecolor 1 1 1 1													\
																											...
																											\
		mouseExit {																							\
			setitemcolor "yn"##YESNO_TEXT forecolor .78 .80 .84 1											\
		}																									\
																											\
		action {																							\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "ynalx"##YESNOALIGNX_TEXT forecolor 1 1 1 1										\
																											...
																											\
		mouseExit {																							\
			setitemcolor "ynalx"##YESNOALIGNX_TEXT forecolor .78 .80 .84 1									\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "ynaction"##YESNOACTION_TEXT forecolor 1 1 1 1										\
																											...
																											\
		mouseExit {																							\
			setitemcolor "ynaction"##YESNOACTION_TEXT forecolor .78 .80 .84 1								\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "check"##CHECKBOX_TEXT forecolor 1 1 1 1											\
																											...
																											\
		mouseExit {																							\
			setitemcolor "check"##CHECKBOX_TEXT forecolor .78 .80 .84 1										\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "checkalx"##CHECKBOXALIGNX_TEXT forecolor 1 1 1 1									\
																											...
																											\
		mouseExit {																							\
			setitemcolor "checkalx"##CHECKBOXALIGNX_TEXT forecolor .78 .80 .84 1							\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor CHECKBOXNOTEXT_NAME forecolor 1 1 1 1												\
																											...
																											\
		mouseExit {																							\
			setitemcolor CHECKBOXNOTEXT_NAME forecolor .78 .80 .84 1										\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor CHECKBOXNOTEXTACTION_NAME forecolor 1 1 1 1											\
																											...
																											\
		mouseExit {																							\
			setitemcolor CHECKBOXNOTEXTACTION_NAME forecolor .78 .80 .84 1									\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "checkaction"##CHECKBOXACTION_TEXT forecolor 1 1 1 1								\
																											...
																											\
		mouseExit {																							\
			setitemcolor "checkaction"##CHECKBOXACTION_TEXT forecolor .78 .80 .84 1							\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "checkactionalx"##CHECKBOXALIGNXACTION_TEXT forecolor 1 1 1 1						\
																											...
																											\
		mouseExit {																							\
			setitemcolor "checkactionalx"##CHECKBOXALIGNXACTION_TEXT forecolor .78 .80 .84 1				\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
...
// -------------------------------------------------------------------
// TRICHECKBOX - Tri-state checkbox
// -------------------------------------------------------------------
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "tricheckaction"##TRICHECKBOXACTION_TEXT forecolor 1 1 1 1							\
																											...
																											\
		mouseExit {																							\
			setitemcolor "tricheckaction"##TRICHECKBOXACTION_TEXT forecolor .78 .80 .84 1					\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "tricheckactionmulti"##TRICHECKBOXACTIONMULTI_CVAR forecolor 1 1 1 1				\
																											...
																											\
		mouseExit {																							\
			setitemcolor "tricheckactionmulti"##TRICHECKBOXACTIONMULTI_CVAR forecolor .78 .80 .84 1			\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
...
// -------------------------------------------------------------------
// MULTI - Multiple-choice selector
// -------------------------------------------------------------------
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "multi"##MULTI_TEXT forecolor 1 1 1 1												\
																											...
																											\
		mouseExit {																							\
			setitemcolor "multi"##MULTI_TEXT forecolor .78 .80 .84 1											\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "multileft"##MULTILEFT_TEXT forecolor 1 1 1 1										\
																											...
																											\
		mouseExit {																							\
			setitemcolor "multileft"##MULTILEFT_TEXT forecolor .78 .80 .84 1								\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "multiaction"##MULTIACTION_TEXT forecolor 1 1 1 1									\
																											...
																											\
		mouseExit {																							\
			setitemcolor "multiaction"##MULTIACTION_TEXT forecolor .78 .80 .84 1								\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "multiactionleft"##MULTIACTIONLEFT_TEXT forecolor 1 1 1 1							\
																											...
																											\
		mouseExit {																							\
			setitemcolor "multiactionleft"##MULTIACTIONLEFT_TEXT forecolor .78 .80 .84 1					\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav" ;																	\
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "slider"##SLIDER_TEXT forecolor 1 1 1 1											\
																											...
																											\
		mouseExit {																							\
			setitemcolor "slider"##SLIDER_TEXT forecolor .78 .80 .84 1										\
		}																									\
	}


// -------------------------------------------------------------------
// BIND - Key binding control
// -------------------------------------------------------------------
	...
	itemDef {																								\
		...
		mouseEnter {																						\
			setitemcolor "bind"##BIND_TEXT forecolor 1 1 1 1												\
																											...
																											\
		mouseExit {																							\
			setitemcolor "bind"##BIND_TEXT forecolor .78 .80 .84 1											\
		}																									\
																											\
		action {																							\
			play "sound/menu/filter.wav"																	\
...
// -------------------------------------------------------------------
// CVARLABEL - Label that displays a cvar value
// -------------------------------------------------------------------
...
#define CVARINTLABEL( CVARFLOATLABEL_X, CVARFLOATLABEL_Y, CVARFLOATLABEL_W, CVARFLOATLABEL_H, CVARFLOATLABEL_CVAR, CVARFLOATLABEL_TEXT_SCALE, CVARFLOATLABEL_TEXT_ALIGN, CVARFLOATLABEL_TEXT_ALIGN_X, CVARFLOATLABEL_TEXT_ALIGN_Y )	\
	itemDef {																								\
		name			"cvarfloatlabel"##CVARFLOATLABEL_CVAR												\
		group			GROUP_NAME																			\
		rect			$evalfloat(CVARFLOATLABEL_X) $evalfloat(CVARFLOATLABEL_Y) $evalfloat(CVARFLOATLABEL_W) $evalfloat(CVARFLOATLABEL_H)	\
